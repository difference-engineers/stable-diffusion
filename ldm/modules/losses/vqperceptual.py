...
def measure_perplexity(predicted_indices, n_embed):
    ...
    # eval cluster perplexity. when perplexity == num_embeddings then all
    # clusters are used exactly equally
    encodings = F.one_hot(
        predicted_indices, n_embed).float().reshape(-1, n_embed)
    ...
    def forward(
        ...
        if optimizer_idx == 1:
            ...
            if cond is None:
                ...
                logits_fake = self.discriminator(torch.cat(
